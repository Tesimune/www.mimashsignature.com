...
import CreateOrderPickupPrice from './Components/CreateOrderPickupPrice';
import OrderPickupPrices from './Components/OrderPickupPrices';

export default function Edit({ store, orderPickupPrices }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route("myStore.update", store.username));
    };
    ...
    return (
        ...
        >
            ...
            <div className="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div className="max-w-7xl py-5 sm:px-6 lg:px-9">
                    <CreateOrderPickupPrice storeData={store} />
                </div>
                <div className="max-w-7xl py-5 sm:px-6 lg:px-9">
                    <OrderPickupPrices orderPickupPrices={orderPickupPrices} />
                </div>
            </div>
        </AuthenticatedLayout>
    );
